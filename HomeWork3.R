...
count_missing = 0 
# o trong R thi co the (nen) goi value de check luon
# van co the lam theo huong index dung  nhung khong nen 
...
# Neu lam nhu the nay phai 1 buoc de assign cac gia tri vao 
